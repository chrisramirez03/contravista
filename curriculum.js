                ...
                sections: [
                  {
                    ...
                    sentences: [
                      ...
                      { id: "s8_5", text: "The equivalent resistance is RTh = Voc / Isc.", start: 35.69, end: 44.67 }
                    ],
                    comparison: {
                      left: {
                        theme: "blue",
                  ...
                  },
                  {
                    ...
                    sentences: [
                      { id: "s8_6", text: "When connecting a load resistor RL to a practical power source with internal resistance RTh, how do you maximize the power delivered to the load?", start: 44.67, end: 52.7 },
                      { id: "s8_7", text: "Maximum power transfer occurs when the load resistance exactly equals the Thevenin resistance: RL = RTh.", start: 52.7, end: 59.26 },
                      { id: "s8_8", text: "The maximum power delivered is: Pmax = VTh² / (4 RTh).", start: 59.26, end: 65.3 }
                    ],
                    callout: {
                      icon: "bulb",
                ...
                sections: [
                  {
                    ...
                    sentences: [
                      { id: "s10_1", text: "An inductor consists of a coil of conducting wire wound around a core of air, iron, or ferrite.", start: 0.1, end: 6.67 },
                      { id: "s10_2", text: "When current flows through the coil, a magnetic field builds up around it.", start: 6.62, end: 11.57 },
                      { id: "s10_3", text: "By Faraday's Law and Lenz's Law, any change in current induces an opposing voltage: v = L × (di / dt).", start: 11.57, end: 20.67 },
                      { id: "s10_4", text: "An inductor resists changes in current.", start: 20.68, end: 23.88 },
                      { id: "s10_5", text: "In a steady-state DC circuit where current is constant (di/dt = 0), an ideal inductor has zero voltage drop and acts as a Short Circuit.", start: 23.88, end: 34.0 }
                    ],
                    callout: {
                      icon: "zap",
                ...
                sections: [
                  {
                    ...
                    sentences: [
                      { id: "s11_1", text: "When a DC voltage source is connected to a series resistor and capacitor, the capacitor does not charge instantly.", start: 0.1, end: 7.42 },
                      { id: "s11_2", text: "Instead, the voltage rises exponentially according to the differential equation solution: v(t) = Vs × (1 - e^(-t / τ)).", start: 7.38, end: 18.57 },
                      { id: "s11_3", text: "The parameter tau (τ = R × C) is the circuit Time Constant, measured in seconds.", start: 18.57, end: 25.56 },
                      { id: "s11_4", text: "After one time constant (t = 1τ), the capacitor charges to 63.2% of its final voltage.", start: 25.56, end: 33.84 },
                      { id: "s11_5", text: "After five time constants (t = 5τ), the capacitor is over 99.3% charged, considered fully steady state.", start: 33.84, end: 43.22 }
                    ],
                    callout: {
                      icon: "bulb",
                ...
                sections: [
                  {
                    ...
                    sentences: [
                      ...
                      { id: "s13_6", text: "Capacitors have impedance ZC = 1 / (j ω C) = -j / (ω C), where current leads voltage by 90 degrees.", start: 49.45, end: 60.69 }
                    ],
                    comparison: {
                      left: {
                        theme: "blue",
                ...
                sections: [
                  {
                    ...
                    sentences: [
                      { id: "s14_1", text: "In AC circuits with inductors and capacitors, voltage and current are out of phase.", start: 0.1, end: 5.97 },
                      { id: "s14_2", text: "Real Power P, measured in Watts, is the actual power converted into useful work and heat: P = Vrms × Irms × cos(theta).", start: 5.92, end: 15.76 },
                      { id: "s14_3", text: "Reactive Power Q, measured in VAR, is the power bouncing between the source and reactive fields: Q = Vrms × Irms × sin(theta).", start: 15.76, end: 26.4 },
                      { id: "s14_4", text: "Apparent Power S, measured in Volt-Amps (VA), is the vector combination: S = sqrt(P² + Q²).", start: 26.4, end: 35.89 },
                      { id: "s14_5", text: "The Power Factor is cos(theta) = P / S.", start: 35.89, end: 46.3 }
                    ],
                    callout: {
                      icon: "zap",
